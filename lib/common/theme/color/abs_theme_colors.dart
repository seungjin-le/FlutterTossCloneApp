...
abstract class AbstractThemeColors {
  ...
  Color get seedColor => AppColors.screenBgColor;
  ...
  Color get appBarBackgroundColor => const Color.fromARGB(266, 16, 16, 18);

  Color get screenBgColor => AppColors.screenBgColor;
}
